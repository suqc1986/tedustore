...
public class Address implements Serializable{
	 ...
	 * 
	 */
	 private static final long serialVersionUID = 7837585955330205313L;
	 private Integer id;
	 private Integer uid;
	...
	public Address(Integer id, Integer uid, String recvName, String recvProvince, String recvCity, String recvArea,
			...
			Integer isDefault, String createdUser, Date createTime, String modifiedUser, Date modifiedTime) {
		super();
		this.id = id;
		this.uid = uid;
		this.recvName = recvName;
