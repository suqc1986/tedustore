...
<body>
							...
							<div class="imfor">
								...
								<div class="pices">
									...
									<p class="pices_information">
										<b>￥</b><span>${goods.price} <input type="hidden"
											name="" value=""></span>
									</p>
								</div>
								<div class="num">
									<span class="reduc">&nbsp;-&nbsp;</span><input type="text"
										value="${goods.count }"><span class="add">&nbsp;+&nbsp;</span>
								</div>
								<div class="totle">
									<span>￥</span> <span class="totle_information">${goods.price*goods.count}</span>
								</div>
								<div class="del">
									<!-- <div>
	...
	<script src="../js/cart_v1.js"></script>
