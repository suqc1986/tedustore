...
<header id="top" class="fixed_nav">
    ...
    <div id="top_input" class="lf" style="margin-left: 65px;">
        <input id="input" type="text" placeholder="请输入您要搜索的内容"/>
        <a href="${pageContext.request.contextPath}/goods/showSearch.do?categoryId=" class="rt"><img id="search" src="${pageContext.request.contextPath}/images/header/search.png" alt="搜索"/></a>
    </div>
    <div class="rt">
        <ul class="lf">
