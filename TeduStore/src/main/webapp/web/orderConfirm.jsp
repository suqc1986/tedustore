	...
	<div id="container" class="clear">
		...
		<form name="" method="post" action="#">
			<div class="product_confirm">
				...
				<c:forEach items="${requestScope.cartVos}" var="cartVo">
					<ul class="item_detail">
						<li class="p_info">
								<b style="width: 20%"> <img style="width: 100%" src="..${cartVo.image}"/></b>
								<b class="product_name lf"> ${cartVo.title} </b>
							<br /> <span class="product_color "> 颜色：深空灰 </span></li>
