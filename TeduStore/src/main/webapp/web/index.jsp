    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
           				<c:forEach items="${computerList}" varStatus="i">
           						<p>${computerList[i.index].name}</p>
		                <ul>
		                			<c:forEach items="${category161List[i.index]}" var = "computer">
		                			 <li><a href="${pageContext.request.contextPath}/goods/showSearch.do?categoryId=${computer.id}">${computer.name}</a></li>
		        							</c:forEach>
		                </ul>
           				</c:forEach>
            </div>
        ...
        <c:forEach items="${goodsList}" var="goods">
	        <div class="item_msg lf">
	            <img style="width:200px" src="${pageContext.request.contextPath}${goods.image}" alt=""/>
	
	            <p style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;" class="bottom_ys2">${goods.title}</p>
	
	            <p class="bottom_ys3">￥${goods.price}</p>
	
	            <p class="bottom_ys4 color_2"><a href="${pageContext.request.contextPath}/goods/goodsInfo.do?goodsId=${goods.id}&categoryId=${goods.categoryId}">查看详情</a></p>
	        </div>
